...
const BigText = () =>{
    ...
    const animation = ()=>{
        ...
        const imagePaths = Array.from({length:405}, (elem,idx)=>{
            return `/src/assets/webFrames/frame${idx}.png`
        })
        ...
        const loopImagesSequence = (timestamps) =>{
            if(images.length == 405 && timestamps - lastFrame >= 1000/30){
                ctx.clearRect(0,0,canvas.width,canvas.height)
                ctx.drawImage(images[currentFrame],0,0,canvas.width,canvas.height)

                currentFrame = (currentFrame+1)% 405
    ...
    return(
        <div id='section2' className='bg-white text-black text-center p-4 sm:p-8 md:p-15 overflow-hidden'>
            <div className='rotateText'>
                <h1 className='text-[32vw] sm:text-[42vw] text-black font-[anzo4] uppercase leading-[28vw] sm:leading-[35vw]'>IMPACTFUL</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[32vw] sm:text-[42vw] text-black font-[anzo4] uppercase leading-[28vw] sm:leading-[35vw]'>DESIGN</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[32vw] sm:text-[42vw] text-black font-[anzo4] uppercase leading-[28vw] sm:leading-[35vw]'>IS THE</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[32vw] sm:text-[42vw] text-black font-[anzo4] uppercase leading-[28vw] sm:leading-[35vw]'>DESIGN</h1>
            </div>
            <div className='rotateText'>
                <h1 className='text-[32vw] sm:text-[42vw] text-black font-[anzo4] uppercase leading-[28vw] sm:leading-[35vw]'>THAT</h1>
            </div>
            <div className='rotateText relative'>
                <canvas className='absolute w-full h-auto max-w-[848px] max-h-[480px]' role="presentation" data-testid="canvas" width="848" height="480"></canvas>
                <h1 className='text-[32vw] sm:text-[42vw] text-black font-[anzo4] uppercase leading-[28vw] sm:leading-[35vw]'>WORKS</h1>
            </div>

            <div className='flex items-center justify-center scale-60 mt-4 sm:mt-8'>
                <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="2037" data-type="ugc" role="img" aria-label="Tesla, Figma, Google+, BeHance monochrome Logo Design by Anzo Studio" className="w-full max-w-[2037px] h-auto">
                <g>
            ...
            <div className='h-0.5 w-1/2 relative rounded left-1/2 -translate-x-1/2 mt-4 sm:mt-5 bg-black'></div>  
        </div>
    )
}
