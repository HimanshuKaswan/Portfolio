...
const BigText = () =>{
    ...
    return(
        <div id='section2' className='bg-white text-black text-center p-15 '>
            ...
            <div className='rotateText relative'>
                <canvas className='absolute' role="presentation" data-testid="canvas" styles="height: 100%; width: 100%; object-fit: contain; object-position: center center;" width="848" height="480"></canvas>
                <h1 className='text-[42vw] text-black font-[anzo4] uppercase leading-[35vw]'>WORKS</h1>
            </div>

            <div className='flex items-center justify-center scale-60'>
